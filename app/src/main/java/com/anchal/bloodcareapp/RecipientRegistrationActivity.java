    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final double weight = Double.parseDouble(registerWeight.getText().toString());
                ...
                {
                    Toast.makeText(RecipientRegistrationActivity.this, "Please Select valid Input", Toast.LENGTH_SHORT).show();
                    return;
                }
